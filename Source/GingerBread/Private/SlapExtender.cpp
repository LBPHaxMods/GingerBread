...
ASlapExtender::ASlapExtender(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
...
void ASlapExtender::WobbleVoxTimelineEvent() {
}

void ASlapExtender::StopTellAnimation() {
}

void ASlapExtender::StartTellAnimation() {
}

void ASlapExtender::StartRetracting() {
}

void ASlapExtender::StartExtending() {
}

void ASlapExtender::RetractingTimelineEvent() {
}


void ASlapExtender::OnSplinePositionChanged(float CurrentPositionAlongSpline, float DeltaTime) {
}

void ASlapExtender::OnSplineMovementStarted(USplineFollowerComponent* pSplineFollowerComponent, const bool WillMoveForwards) {
}

void ASlapExtender::OnSplineEndReached(USplineFollowerComponent* pSplineFollowerComponent, const bool WasMovingForwards) {
}


void ASlapExtender::OnRightEyeTimelineUpdate(const float Alpha) {
}

void ASlapExtender::OnRightEyeInteractEnd(UInteractionComponent* pOverlapComponent, AActor* pOtherActor, UInteractionComponent* pOtherComp) {
}

void ASlapExtender::OnRightEyeInteractBegin(UInteractionComponent* pOverlapComponent, AActor* pOtherActor, UInteractionComponent* pOtherComp) {
}

void ASlapExtender::OnRightEyeComponentOverlapEnd(UPrimitiveComponent* pOverlapComponent, AActor* pOtherActor, UPrimitiveComponent* pOtherComp, int32 OtherBodyIndex) {
}

void ASlapExtender::OnRightEyeComponentOverlap(UPrimitiveComponent* pOverlapComponent, AActor* pOtherActor, UPrimitiveComponent* pOtherComp, int32 OtherBodyIndex, bool FromSweep, const FHitResult& SweepResult) {
}

void ASlapExtender::OnRetractTellTimelineUpdate(const FVector Alpha) {
}



void ASlapExtender::OnRep_State() {
}

void ASlapExtender::OnLeftEyeTimelineUpdate(const float Alpha) {
}

void ASlapExtender::OnLeftEyeInteractEnd(UInteractionComponent* pOverlapComponent, AActor* pOtherActor, UInteractionComponent* pOtherComp) {
}

void ASlapExtender::OnLeftEyeInteractBegin(UInteractionComponent* pOverlapComponent, AActor* pOtherActor, UInteractionComponent* pOtherComp) {
}

void ASlapExtender::OnLeftEyeComponentOverlapEnd(UPrimitiveComponent* pOverlapComponent, AActor* pOtherActor, UPrimitiveComponent* pOtherComp, int32 OtherBodyIndex) {
}

void ASlapExtender::OnLeftEyeComponentOverlap(UPrimitiveComponent* pOverlapComponent, AActor* pOtherActor, UPrimitiveComponent* pOtherComp, int32 OtherBodyIndex, bool FromSweep, const FHitResult& SweepResult) {
}



void ASlapExtender::OnButtonInteractEnd(UInteractionComponent* pOverlapComponent, AActor* pOtherActor, UInteractionComponent* pOtherComp) {
}

void ASlapExtender::OnButtonInteractBegin(UInteractionComponent* pOverlapComponent, AActor* pOtherActor, UInteractionComponent* pOtherComp) {
}

void ASlapExtender::OnButtonDepressTimelineUpdate(const float Alpha) {
}

void ASlapExtender::OnButtonComponentOverlapEnd(UPrimitiveComponent* pOverlapComponent, AActor* pOtherActor, UPrimitiveComponent* pOtherComp, int32 OtherBodyIndex) {
}

void ASlapExtender::OnButtonComponentOverlap(UPrimitiveComponent* pOverlapComponent, AActor* pOtherActor, UPrimitiveComponent* pOtherComp, int32 OtherBodyIndex, bool FromSweep, const FHitResult& SweepResult) {
}

void ASlapExtender::HitSoundsTimelineEvent() {
}

void ASlapExtender::FirstHitTimelineEvent() {
}

void ASlapExtender::ExtendingTimelineDone() {
}

void ASlapExtender::EndRetractAnimTimelineEvent() {
}

void ASlapExtender::EndExpandAnimTimelineEvent() {
}

void ASlapExtender::BeginRetractAnimTimelineEvent() {
}

void ASlapExtender::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const {
    Super::GetLifetimeReplicatedProps(OutLifetimeProps);
    
    DOREPLIFETIME(ASlapExtender, State);
}
