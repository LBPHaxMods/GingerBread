...
ABogieBoi::ABogieBoi(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->State = EBogieBoiState::Peeping;
    this->IsActive = true;
...
void ABogieBoi::StartLaunchTellMontageCSPAction() {
}

void ABogieBoi::PlayBashedDownReactionMontage_Implementation(float StartPosition) {
}

void ABogieBoi::OnScrewCooldownTimerComplete() {
}

void ABogieBoi::OnRep_State(EBogieBoiState OldState) {
}

void ABogieBoi::OnPlayMontageAnimNotifyBegin(FName NotifyName, const FBranchingPointNotifyPayload& BranchingPointPayload) {
}

void ABogieBoi::OnOuterBeginOverlapAnySackboy(UOverlapManagerComponent* pOverlapManagerComponent, UPrimitiveComponent* pOverlappedComponent, ASackboy* pOtherSackboy, UPrimitiveComponent* pOtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult) {
}

void ABogieBoi::OnOuterBeginInteractAnySackboy(UOverlapManagerComponent* pOverlapManagerComponent, UInteractionComponent* pOverlappedComponent, ASackboy* pOtherSackboy, UInteractionComponent* pOtherComp) {
}

void ABogieBoi::OnMontageEnded(UAnimMontage* pMontage, bool interrupted) {
}

void ABogieBoi::OnLookAroundTimerComplete() {
}

void ABogieBoi::OnLeavingEndOverlapAnySackboy(UOverlapManagerComponent* pOverlapManagerComponent, UPrimitiveComponent* pOverlappedComponent, ASackboy* pOtherSackboy, UPrimitiveComponent* pOtherComp, int32 OtherBodyIndex) {
}

void ABogieBoi::OnLeavingEndInteractAnySackboy(UOverlapManagerComponent* pOverlapManagerComponent, UInteractionComponent* pOverlappedComponent, ASackboy* pOtherSackboy, UInteractionComponent* pOtherComp) {
}

void ABogieBoi::OnInnerEndOverlapAnySackboy(UOverlapManagerComponent* pOverlapManagerComponent, UPrimitiveComponent* pOverlappedComponent, ASackboy* pOtherSackboy, UPrimitiveComponent* pOtherComp, int32 OtherBodyIndex) {
}

void ABogieBoi::OnInnerEndInteractAnySackboy(UOverlapManagerComponent* pOverlapManagerComponent, UInteractionComponent* pOverlappedComponent, ASackboy* pOtherSackboy, UInteractionComponent* pOtherComp) {
}

void ABogieBoi::OnInnerBeginOverlapAnySackboy(UOverlapManagerComponent* pOverlapManagerComponent, UPrimitiveComponent* pOverlappedComponent, ASackboy* pOtherSackboy, UPrimitiveComponent* pOtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult) {
}

void ABogieBoi::OnInnerBeginInteractAnySackboy(UOverlapManagerComponent* pOverlapManagerComponent, UInteractionComponent* pOverlappedComponent, ASackboy* pOtherSackboy, UInteractionComponent* pOtherComp) {
}

void ABogieBoi::OnDizzyCountDownTimerComplete() {
}

void ABogieBoi::OnCSPActionEvent(uint32 Action) {
}

void ABogieBoi::EnableCollisionOnLastSpawnedSpikeyRoller() {
}

void ABogieBoi::EDITOR_CopyProperties(bool InStartsActive, bool InManualMode, bool InConstantFireMode, bool InShootWhileSackboyIsBelow, float InStartDelay, float InShootingCooldown, float InProjectileLaunchSpeed, float InFireArcLimit, float InRollerLifeSpan, float InLaunchStrength) {
}

void ABogieBoi::DisableCollisionOnShootingHurtBox() {
}

void ABogieBoi::AUTH_StartDoingStuff() {
}

void ABogieBoi::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const {
    Super::GetLifetimeReplicatedProps(OutLifetimeProps);
    
    DOREPLIFETIME(ABogieBoi, State);
    DOREPLIFETIME(ABogieBoi, IsActive);
    DOREPLIFETIME(ABogieBoi, ScrewedDown);
}
