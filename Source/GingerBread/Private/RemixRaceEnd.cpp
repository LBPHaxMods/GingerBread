...
ARemixRaceEnd::ARemixRaceEnd(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
...
void ARemixRaceEnd::RESET() {
}

void ARemixRaceEnd::OnTimedChallengeAvailable(AActor* ManagerActor) {
}

void ARemixRaceEnd::OnLevelSettingsAvailable(AActor* Manager) {
}

void ARemixRaceEnd::OnFinishLineBeginOverlapInteract(UInteractionComponent* OverlappedComponent, AActor* OtherActor, UInteractionComponent* OtherComp) {
}

void ARemixRaceEnd::OnFinishLineBeginOverlap(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult) {
}
