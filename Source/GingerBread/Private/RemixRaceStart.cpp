...
ARemixRaceStart::ARemixRaceStart(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
...
void ARemixRaceStart::StartCountdown() {
}

void ARemixRaceStart::RESET() {
}

void ARemixRaceStart::OnTimedChallengeAvailable(AActor* ManagerActor) {
}

void ARemixRaceStart::OnStartTimerCollisionBeginOverlap(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult) {
}

void ARemixRaceStart::OnPostSpawn(USpawnPointComponent* SpawnPoint, bool first_time) {
}

void ARemixRaceStart::OnLevelSettingsAvailable(AActor* Manager) {
}

void ARemixRaceStart::OnCutsceneManagerAvailable(AActor* pManagerActor) {
}

void ARemixRaceStart::DroneRiseFinished() {
}

void ARemixRaceStart::DroneRiseCallback(float val) {
}

void ARemixRaceStart::DroneDropCallback(float val) {
}

void ARemixRaceStart::DisableStartGateTick(UAnimationAsset* Animation) {
}

void ARemixRaceStart::CountdownFinished() {
}

void ARemixRaceStart::CountdownCallback(float val) {
}

void ARemixRaceStart::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const {
    Super::GetLifetimeReplicatedProps(OutLifetimeProps);
    
    DOREPLIFETIME(ARemixRaceStart, AUTH_bIsOpen);
}
