...
#include "CrateDamagedDelegate.h"
#include "CrateDestroyedDelegate.h"
...
class ACrateBase : public APlayerCountActor, public IWakeSleep, public IHitPointsComponentEventReceiver, public IThreadInterface, public IDarkMatterEngineMovable, public ISackboyDetection, public IBouncePadBouncer {
    GENERATED_BODY()
public:
protected:
    ...
    FCrateDestroyed OnCrateDestroyed;
    
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FCrateDamaged OnCrateDamaged;
...
public:
    ACrateBase(const FObjectInitializer& ObjectInitializer);
