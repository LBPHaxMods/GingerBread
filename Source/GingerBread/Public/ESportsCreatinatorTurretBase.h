...
#include "OnESportsCreatinatorTurretDestroyedDelegate.h"
#include "Templates/SubclassOf.h"
#include "WakeSleep.h"
#include "PlayerCountActor.h"
#include "ESportsCreatinatorTurretBase.generated.h"
...
class AESportsCreatinatorTurretBase : public APlayerCountActor, public ILevelObject, public IWakeSleep, public IHitPointsComponentEventReceiver, public IIAIAudio, public ICreatinatorTurret {
    GENERATED_BODY()
public:
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FOnESportsCreatinatorTurretDestroyed OnTurretDestroyed;
    
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FOnESportsCreatinatorTurretDestroyed OnTurretHatDestroyed;
...
public:
    AESportsCreatinatorTurretBase(const FObjectInitializer& ObjectInitializer);
