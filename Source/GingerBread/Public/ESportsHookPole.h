...
#include "ESportsHookPole.generated.h"
...
class AESportsHookPole : public AActor, public ISackboyDetection {
    GENERATED_BODY()
public:
...
public:
    AESportsHookPole(const FObjectInitializer& ObjectInitializer);
