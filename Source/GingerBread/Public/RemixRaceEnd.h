...
#include "RemixRaceEnd.generated.h"
...
class ARemixRaceEnd : public AActor {
    GENERATED_BODY()
public:
protected:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TMap<EWorldLocation, FEndGateWorldSetup> WorldSetupData;
...
public:
    ARemixRaceEnd(const FObjectInitializer& ObjectInitializer);
