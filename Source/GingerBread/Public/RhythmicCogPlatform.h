...
#include "RhythmicCogPlatform.generated.h"
...
class ARhythmicCogPlatform : public APlayerCountActor, public IWakeSleep, public IRhythmicBeatReceiver, public ISackboyDetection {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Instanced, meta=(AllowPrivateAccess=true))
    UTimelineComponent* RotationTimelineComponent;
...
private:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Replicated, meta=(AllowPrivateAccess=true))
    bool ShouldRotateBackwards;
    
public:
    ARhythmicCogPlatform(const FObjectInitializer& ObjectInitializer);
...
protected:
    UFUNCTION(BlueprintCallable)
    void CopyProperties(float InAnglePerRotation, bool InUseOscillatingMovement);
