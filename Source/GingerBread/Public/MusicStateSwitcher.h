...
#include "MusicStateSwitcher.generated.h"
...
class AMusicStateSwitcher : public AActor, public ISackboyDetection {
    GENERATED_BODY()
public:
protected:
    ...
    TArray<FMusicStateTableRow> MusicStateSequence;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    bool UseFillSounds;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TEnumAsByte<EFillInstruments::Type> FillInstrument;
    
public:
    AMusicStateSwitcher(const FObjectInitializer& ObjectInitializer);

protected:
    UFUNCTION(BlueprintCallable)
    void UpdateMusicStateSequencePostDelay();
    
    UFUNCTION(BlueprintCallable)
    void OnMusicStateChanged(ARhythmManager* pRhythmManager, FMusicStateTableRow NewMusicState, FMusicStateTableRow PreviousMusicState);
