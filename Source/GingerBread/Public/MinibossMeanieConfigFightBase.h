...
#include "MinibossMeanieConfigFightBase.generated.h"

UCLASS(Blueprintable, DefaultConfig, Config=MinibossMeanieFight)
class UMinibossMeanieConfigFightBase : public UAIConfigBase {
    GENERATED_BODY()
public:
    ...
    UMinibossMeanieConfigFightBase();
