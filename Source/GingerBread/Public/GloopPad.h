...
class AGloopPad : public APlayerCountActor, public ISackboyDetection, public IWakeSleep {
    GENERATED_BODY()
public:
    ...
    AGloopPad(const FObjectInitializer& ObjectInitializer);
