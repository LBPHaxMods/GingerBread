...
#include "SlapExtenderExtendedDelegate.h"
#include "SlapExtenderExtendingDelegate.h"
#include "SlapExtenderMaterialSet.h"
#include "SlapExtenderRetractedDelegate.h"
#include "SlapExtenderRetractingDelegate.h"
#include "SlapExtenderSizeDatum.h"
#include "WakeSleep.h"
#include "PlayerCountActor.h"
#include "SlapExtender.generated.h"
...
class ASlapExtender : public APlayerCountActor, public IWakeSleep, public ISackboyDetection, public IHitPointsComponentEventReceiver {
    GENERATED_BODY()
public:
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FSlapExtenderExtending OnExtendingDispatcher;
    
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FSlapExtenderExtended OnExtendedDispatcher;
    
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FSlapExtenderRetracting OnRetractingDispatcher;
    
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FSlapExtenderRetracted OnRetractedDispatcher;
...
public:
    ASlapExtender(const FObjectInitializer& ObjectInitializer);
