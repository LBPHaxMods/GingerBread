...
#include "ERhythmicLaserAudioType.h"
#include "ERhythmicLaserModuleType.h"
...
#include "RhythmicLaserModule.generated.h"
...
class ARhythmicLaserModule : public APlayerCountActor, public ISackboyDetection, public IHitPointsModifierComponentEventReceiver, public ILevelObject, public IWakeSleep, public IRhythmicBeatReceiver {
    GENERATED_BODY()
public:
...
protected:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    ERhythmicLaserModuleType LaserType;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    ERhythmicLaserAudioType AudioType;
...
private:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FRhythmicLaserModuleUnit> RhythmicLaserModuleUnits;
...
public:
    ARhythmicLaserModule(const FObjectInitializer& ObjectInitializer);
