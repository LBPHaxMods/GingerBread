...
#include "RollingYeti_LineStateDelegate.h"
#include "WakeSleep.h"
#include "PlayerCountActor.h"
#include "RollingYeti_Line.generated.h"
...
class ARollingYeti_Line : public APlayerCountActor, public IHitPointsComponentEventReceiver, public ILevelObject, public IWakeSleep {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Instanced, meta=(AllowPrivateAccess=true))
    UCapsuleComponent* HitPointsModification_Collider;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Instanced, meta=(AllowPrivateAccess=true))
    TArray<USkeletalMeshComponent*> ExtraSkeletalMeshComponents;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Instanced, meta=(AllowPrivateAccess=true))
    TArray<USphereComponent*> ExtraSphereCollisions;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Instanced, meta=(AllowPrivateAccess=true))
    TArray<UParticleSystemComponent*> ExtraParticleComponents;
    ...
    FRollingYeti_LineState OnStartedFalling;
    
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FRollingYeti_LineState OnLanded;
    
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FRollingYeti_LineState OnReset;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Replicated, meta=(AllowPrivateAccess=true))
    bool bIsSpawnedAwake;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    float CapsuleRadMultiplier;
    ...
    ARollingYeti_Line(const FObjectInitializer& ObjectInitializer);
