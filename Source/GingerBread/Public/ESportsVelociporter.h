...
#include "EESportsVelociporterColour.h"
#include "LevelObject.h"
#include "WakeSleep.h"
#include "ESportsVelociporter.generated.h"

class AESportsVelociporter;
class UAkAudioEvent;
class UAkComponent;
...
class AESportsVelociporter : public AActor, public IWakeSleep, public ILevelObject {
    GENERATED_BODY()
public:
protected:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    AESportsVelociporter* TargetVelociporter;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<AESportsVelociporter*> TargetVelociporters;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    EESportsVelociporterColour Colour;
...
public:
    AESportsVelociporter(const FObjectInitializer& ObjectInitializer);
