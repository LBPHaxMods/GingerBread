...
#include "ShieldConfigGenericBase.generated.h"

class UCurveFloat;

UCLASS(Blueprintable, DefaultConfig, Config=ShieldGeneric)
class UShieldConfigGenericBase : public UAIConfigBase {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(BlueprintReadWrite, Config, EditAnywhere, meta=(AllowPrivateAccess=true))
    float ReturnHomeRotationSpeed;
    
    UShieldConfigGenericBase();
