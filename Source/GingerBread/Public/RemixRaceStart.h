...
#include "WakeSleep.h"
#include "RemixRaceStart.generated.h"
...
class ARemixRaceStart : public AActor, public ISackboyDetection, public IWakeSleep {
    GENERATED_BODY()
public:
...
protected:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TMap<EWorldLocation, FStartGateWorldSetup> WorldSetupData;
...
public:
    ARemixRaceStart(const FObjectInitializer& ObjectInitializer);
