...
#include "ESpikeyRollerAudioType.h"
#include "HitPointsModifierComponentEventReceiver.h"
#include "LevelObject.h"
#include "WakeSleep.h"
#include "PlayerCountActor.h"
#include "SpikeyRoller.generated.h"
...
class ASpikeyRoller : public APlayerCountActor, public IWakeSleep, public ILevelObject, public IHitPointsModifierComponentEventReceiver {
    GENERATED_BODY()
public:
...
protected:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    ESpikeyRollerAudioType AudioType;
...
public:
    ASpikeyRoller(const FObjectInitializer& ObjectInitializer);
