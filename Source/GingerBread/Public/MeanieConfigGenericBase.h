...
#include "MeanieConfigGenericBase.generated.h"

class UCurveFloat;

UCLASS(Blueprintable, DefaultConfig, Config=MeanieGeneric)
class UMeanieConfigGenericBase : public UAIConfigBase {
    GENERATED_BODY()
public:
