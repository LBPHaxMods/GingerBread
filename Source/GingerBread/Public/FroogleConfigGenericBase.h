...
#include "FroogleConfigGenericBase.generated.h"

class UCurveFloat;
class UParticleSystem;

UCLASS(Blueprintable, DefaultConfig, Config=FroogleGeneric)
class UFroogleConfigGenericBase : public UAIConfigBase {
    GENERATED_BODY()
public:
