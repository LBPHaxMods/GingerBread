...
#include "BogieBoiGenericDelegateDelegate.h"
#include "BogieBoiGotHitDelegateDelegate.h"
#include "BogieBoiLaunchedDelegateDelegate.h"
#include "EBogieBoiState.h"
#include "HitPointsComponentEventReceiver.h"
#include "LevelObject.h"
#include "Templates/SubclassOf.h"
#include "WakeSleep.h"
#include "PlayerCountActor.h"
#include "BogieBoi.generated.h"
...
class ABogieBoi : public APlayerCountActor, public IWakeSleep, public ILevelObject, public IHitPointsComponentEventReceiver {
    GENERATED_BODY()
public:
protected:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TSubclassOf<APhysicsSpikeyRoller> SpikeyRollerClass;
...
public:
    ...
    FBogieBoiGenericDelegate OnBogieBoiShoot;
    
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FBogieBoiGotHitDelegate OnBogieBoiGotHit;
    
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FBogieBoiLaunchedDelegate OnBogieBoiLaunched;
    
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FBogieBoiGenericDelegate OnBogieBoiStartedPeeping;
    
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FBogieBoiGenericDelegate OnBogieBoiStartedHiding;
    
private:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Transient, meta=(AllowPrivateAccess=true))
    TArray<APhysicsSpikeyRoller*> DeferredSpikeyRollers;
    
    UPROPERTY(EditAnywhere, ReplicatedUsing=OnRep_State, meta=(AllowPrivateAccess=true))
    EBogieBoiState State;
...
public:
    ABogieBoi(const FObjectInitializer& ObjectInitializer);
...
protected:
    ...
    UFUNCTION()
    void OnRep_State(EBogieBoiState OldState);
