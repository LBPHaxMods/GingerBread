...
#include "CutterTeleporter.generated.h"
...
class ACutterTeleporter : public APlayerCountActor, public ISackboyDetection, public IWakeSleep {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Instanced, meta=(AllowPrivateAccess=true))
    UAkComponent* Ak_CutterTeleporter;
...
public:
    ACutterTeleporter(const FObjectInitializer& ObjectInitializer);
