...
#include "PhysicsSpikeyRoller.generated.h"
...
class APhysicsSpikeyRoller : public APlayerCountActor, public IWakeSleep, public ILevelObject, public IDarkMatterEngineMovable, public IHitPointsModifierComponentEventReceiver {
    GENERATED_BODY()
public:
...
public:
    APhysicsSpikeyRoller(const FObjectInitializer& ObjectInitializer);
