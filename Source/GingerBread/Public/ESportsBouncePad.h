...
#include "ESportsBouncePad.generated.h"
...
class AESportsBouncePad : public APlayerCountActor, public ISackboyDetection, public IBouncePadSharedData, public IWakeSleep {
    GENERATED_BODY()
public:
...
public:
    AESportsBouncePad(const FObjectInitializer& ObjectInitializer);
