...
#include "Carryable.h"
#include "DuopedeKilledEventDelegate.h"
#include "DuopedePickedUpEventDelegate.h"
...
#include "DuopedeSegment.generated.h"
...
class ADuopedeSegment : public APlayerCountActor, public ISackboyDetection, public IHitPointsComponentEventReceiver, public IHitPointsModifierComponentEventReceiver, public ICarryable, public IFloatyBubbleEventReceiver, public IIAIAudio {
    GENERATED_BODY()
public:
protected:
...
public:
    ...
    FDuopedeKilledEvent DuopedeKilled;
    
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FDuopedePickedUpEvent DuopedePickedUp;
...
protected:
    ...
    EDuopedePositions DuopedePosition;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Replicated, meta=(AllowPrivateAccess=true))
    EDuopedePositions DefaultPosition;
...
public:
    ADuopedeSegment(const FObjectInitializer& ObjectInitializer);
