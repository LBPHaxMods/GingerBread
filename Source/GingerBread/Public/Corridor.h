...
#include "ECorridorBreakoutDirection.h"
#include "ECorridorRestrictionDirection.h"
...
class ACorridor : public AActor, public IWakeSleep, public ISackboyDetection {
    GENERATED_BODY()
public:
private:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Instanced, meta=(AllowPrivateAccess=true))
    UInteractionComponent* BoxInteractionComponent;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    ECorridorRestrictionDirection RestrictionDirection;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    ECorridorBreakoutDirection BreakoutDirection;
