...
{
	return AssetsActivatedInternal(InObjects, ActivationType);
}
#else
...
{
	AssetsActivatedInternal(InObjects, ActivationType);
}
#endif

bool FAssetTypeActions_AkAudioEvent::AssetsActivatedInternal( const TArray<UObject*>& InObjects, EAssetTypeActivationMethod::Type ActivationType )
{
...
#else
			return FAssetEditorManager::Get().OpenEditorForAsset(InObjects[0]);
#endif
		}
...
#else
			return FAssetEditorManager::Get().OpenEditorForAssets(InObjects);
#endif
		}
	}
